            ...
            return (
              <div key={batch.id} className="bg-white rounded-xl border border-gray-200 p-5">
                ...
                <div className="flex gap-6 text-sm flex-wrap">
                  ...
                  {cout > 0 && <span><strong className="text-gray-900">{Math.round(cout).toLocaleString('fr-FR')} €</strong> <span className="text-gray-400">({masseTotale > 0 ? Math.round(cout / masseTotale * 1000) : 0} €/t)</span></span>}
                </div>
